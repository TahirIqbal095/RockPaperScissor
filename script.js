...
document.querySelector(".btn1").addEventListener("click", function innerHtmlFirst() {
  ...
  if(innerButton==bot){
    ...
    document.querySelector(".result-bot").innerHTML = "Draw";
    ...
    document.querySelector(".result-bot").innerHTML = "You Lose";
    ...
    document.querySelector(".result-bot").innerHTML = "You Win";
